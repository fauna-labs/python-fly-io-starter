...
customers = {
    ...
    "data": [
        ...
        },
        {
            ...
            "creditCard": {"network": "Visa", "number": "4916112310613672"},
        },
        {
            "id": "103",
            "firstName": "Carol",
            ...
            "creditCard": {"network": "Amex", "number": "4532636730015542"},
        },
    ],
}
    ...
    "data": [
        {
            ...
            "customer": "103",
            "orderProducts": [
                {"product": "201", "quantity": 25, "price": 6.98},
                {"product": "203", "quantity": 10, "price": 4.99},
            ],
            "status": "complete",
        ...
        },
        {
            ...
            "customer": "102",
            "orderProducts": [
                {"product": "203", "quantity": 15, "price": 4.99},
                {"product": "202", "quantity": 45, "price": 24.99},
            ],
            "status": "processing",
            "creationDate": "2022-06-08T16:24:53.202530Z",
            "deliveryAddress": {
        ...
        },
        {
            ...
            "customer": "101",
            "orderProducts": [
                {"product": "204", "quantity": 10, "price": 3.99},
                {"product": "206", "quantity": 5, "price": 3.49},
                {"product": "208", "quantity": 20, "price": 1.49},
            ],
            "status": "processing",
            "creationDate": "2022-06-08T16:24:53.202530Z",
            "deliveryAddress": {
